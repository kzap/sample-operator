...
//+kubebuilder:rbac:groups=webapp.mydev.org,resources=redis,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=webapp.mydev.org,resources=redis/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=webapp.mydev.org,resources=redis/finalizers,verbs=update
...
func (r *RedisReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := log.
		FromContext(ctx).
		WithValues("redis", req.NamespacedName)
